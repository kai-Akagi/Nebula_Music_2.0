...
public class UsuarioServletAPI extends HttpServlet {
   ...
   private IUsuarioService usuarioService = new UsuarioService();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //GET www.myservidor.com/api/usuario?id=1  //EL CLIENTE QUIERE OBTENER EL USUARIO 1 request.getParameter
        //GET www.myservidor.com/api/usuario/1 //EL CLIENTE QUIERE OBTENER EL USUARIO 1
        //GET www.myservidor.com/api/usuario?nombre=martion  //EL CLIENTE QUIERE OBTENER EL USUARIO CON NOMBRE MARTIN
        ...
        try{
            ...
            if(pathInfo == null || pathInfo.equals("/")){
                ...
                if(usuario == null){
                    ...
                    mensaje.setMessage("No se encontró el usuario buscado");
            ...
            ResponseMessageDTO mensaje = new ResponseMessageDTO();
                ...
                mensaje.setSuccess(false);
                mensaje.setMessage("Ocurrió un error al procesar la solicitud");
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response)
        ...
        // Y EN EL CUERPO DE LA SOLICITUD EL OBJETO CON LOS CAMPOS ACTUALIZADOS
        try {
            // PARAMETRO
            String pathInfo = request.getPathInfo();
